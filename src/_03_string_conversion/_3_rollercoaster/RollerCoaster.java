...
public static void main(String[] args) {
	...
	// 1) Make a main method that includes all the steps below…. 
		...
		String userHeight = JOptionPane.showInputDialog(null,"Enter your height (inches).");
		int heightToRide = Integer.parseInt(userHeight);
		// Uncomment the line below...
		if( heightToRide > 48 ) { 
		JOptionPane.showMessageDialog(null, "You are tall enough to ride alone!");	
		}
		else {
		if(heightToRide > 41){
		JOptionPane.showMessageDialog(null, "You are tall enough to ride with another person!");	
		}
		}
		if(heightToRide < 42) {
